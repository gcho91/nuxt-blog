...
I will be using an _Ubuntu 18.04_ DigitalOcean Droplet, you can use my referral link to get a free \$100 credit that you could use to deploy your virtual machines and test the guide yourself on a few DigitalOcean servers:
